...
// WICHTIG: Das ist NICHT der Changelog. Hier steht der ZUSTAND ("ein Angebot
// wartet auf die Freigabe"), dort die Aenderung ("ein Angebot wartet JETZT auf
// die Freigabe"). Wer eine Funktion umbaut oder abschaltet, zieht diesen Text
...
const APP_FUNKTIONEN = [
  ...
  },
  {
    ...
    items: [
      ...
      "Vorname, Nachname und E-Mail-Adresse sind Pflicht. Diese Angaben stehen nie in der Börse; sie dienen nur dazu, eine Anfrage zustellen zu können.",
  ...
  },
  {
    ...
    items: [
      "Zu jedem Teil stehen dort nur Foto, Art, Größe, Zustand und Bemerkung. Weder Name noch Kontakt der anbietenden Familie ist zu sehen.",
  ...
  },
  {
    title: "Anfragen",
    items: [
      "Wer ein Teil haben möchte, hinterlässt Vorname, Nachname und E-Mail-Adresse; Telefonnummer und eine Nachricht sind freiwillig.",
      "Die Anfrage geht als E-Mail direkt an die anbietende Familie und steht zusätzlich im Reiter „Anfragen“, damit ein Bearbeiter nachfassen kann, wenn nichts passiert.",
  ...
  },
  {
    ...
    items: [
      "Jedes Angebot hat einen eigenen geheimen Link. Er steht in jeder E-Mail an die anbietende Familie. Ein Klick darauf nimmt das Teil aus der Börse — ohne Anmeldung, ohne Umweg über den Verein.",
      "Ein Bearbeiter kann jedes Angebot ebenso als vergeben markieren oder ganz löschen.",
      "Ein vergebenes Angebot lässt sich mit „Wieder in die Börse“ zurückholen. Nach einem Fehlklick oder einer geplatzten Übergabe muss niemand alles neu einstellen.",
      "Beim Ablehnen und beim Löschen gehen die Fotos aus der Vereins-Cloud mit. Bleibt dabei eines liegen, sagt die App ausdrücklich, wie viele es sind."
    ]
  },
  {
    title: "Grenzen",
    items: [
      ...
      "Ein Teil trägt höchstens drei Fotos.",
      "Es gibt keinen Versand und keine Übergabe über den Verein: Familie und Familie machen das unter sich aus.",
      "Ein gelöschtes Angebot nimmt seine Fotos und seine Anfragen mit — zurückholen lässt es sich danach nicht."
    ]
  },
  {
    title: "Wer darf was",
  ...
  },
  {
    ...
    items: [
      ...
      "Beide Formulare auf der Eltern-Seite tragen ihre eigene Datenschutz-Information nach Art. 13 DSGVO.",
      "Endet die Anmeldung, während die Verwaltungsseite offen ist, wird der Bildschirm geräumt: Angebote, ein groß geöffnetes Foto und der eigene Name oben rechts verschwinden."
    ]
  },
  {
